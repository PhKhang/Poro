    ...
    <div class="background-settings" v-show="isVisible">
      ...
      <div class="youtube-input">
        ...
        <div class="youtube-url-container">
            ...
            <textarea v-model="temporaryYoutubeURL" id="youtube-url" @keydown.enter.prevent="playVid" placeholder="Paste a Youtube URL here"></textarea>
        </div>
      </div>
...
.youtube-url-container textarea {
  ...
  height: 100%; /* Đặt chiều cao để phù hợp với container */
  line-height: 41px; /* Đặt line-height bằng chiều cao để căn giữa */
  white-space: nowrap;
  color: #ededed;
  font-family: "Source Sans 3";
  font-size: 16px;
