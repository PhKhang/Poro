    ...
    <div class="right">
      <div class="signup">
        ...
        <div class="login">
          ...
          <button @click="Login_pages" class="login_button">Login</button>
        </div>
      </div>
    </div>
    <!-- Modal for account already exists -->
    <div
      v-if="showModal_exists"
      class="modal-overlay-exists"
      @click="closeModal"
    >
      <div class="modal-content" @click.stop>
        <h2>Account already exits!</h2>
        <div class="choice_btn">
          <button @click="Login_pages" class="login_btn">Login</button>
          <button @click="closeModal" class="close_btn">Close</button>
        </div>
      </div>
    </div>
...
function closeModal() {
  ...
  showModal_exists.value = false;
}

// Cleanup the timer if component is unmounted
onUnmounted(() => {
  if (autoRedirectTimer) {
    clearTimeout(autoRedirectTimer);
  }
